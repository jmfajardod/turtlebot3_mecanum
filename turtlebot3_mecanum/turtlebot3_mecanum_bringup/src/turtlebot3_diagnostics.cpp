...
#include <turtlebot3_msgs/SensorStateMecanum.h> // Added Mecanum
...
void sensorStateMecanumMsgCallback(const turtlebot3_msgs::SensorStateMecanum::ConstPtr &msg) // added Mecanum
{
  if (msg->battery > 11.0)
  ...
  if (msg->button == turtlebot3_msgs::SensorStateMecanum::BUTTON0) // added Mecanum
    setButtonDiagnosis(diagnostic_msgs::DiagnosticStatus::OK, "BUTTON 0 IS PUSHED");
  else if (msg->button == turtlebot3_msgs::SensorStateMecanum::BUTTON1) // added Mecanum
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber tb3_sensor  = nh.subscribe("sensor_state", 10, sensorStateMecanumMsgCallback);
